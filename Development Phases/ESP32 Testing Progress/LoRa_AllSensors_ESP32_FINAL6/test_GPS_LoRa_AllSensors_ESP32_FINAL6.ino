...
void parseStm32Data(String data) 
{
  String temp = getValueFromData(data, ',', "T:");
  String humidity = getValueFromData(data, ',', "H:");
  String irState = getValueFromData(data, ',', "IR:");
  String soundValue = getValueFromData(data, ',', "S:");
  String speed = getValueFromData(data, ',', "Speed:");
  String accel = getValueFromData(data, ',', "Acc:");
  String rpm = getValueFromData(data, ',', "RPM:");
  String idle = getValueFromData(data, ',', "Idle:");
  String seq = getValueFromData(data, ',', "Seq:");
  
  String irStatus = (irState == "0") ? "CLEAR" : "OBSTACLE";

  Serial.println("DHT11 Temp: " + temp + " C");
  Serial.println("DHT11 Hum: " + humidity + " %");
  Serial.println("IR State: " + irStatus);
  Serial.println("Sound Value: " + soundValue);
